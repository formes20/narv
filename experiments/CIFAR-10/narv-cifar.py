...
######## properties
from inputs.delta_00001_img_4 import TEST_PROPERTY_CIFAR
...
def one_experiment(
    ...
    test_property = TEST_PROPERTY_CIFAR.get(property_id, None)
    dynamically_import_marabou(query_type=test_property["type"])

    fullname = "./networks/cifar_{}.nnet".format(nnet_filename)
...
if __name__ == '__main__':
    one_exp_res = one_experiment(
        nnet_filename="4x100",
        # property id in the input property file
        property_id="adversarial_4",
        # marabou_with_ar or marabou
        mechanism="marabou",
        # When use marabou_with_ar mechanism, abstraction and refinement type are avaible
