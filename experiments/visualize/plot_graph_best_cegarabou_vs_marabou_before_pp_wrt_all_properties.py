...
def main(exp_dirname):
    ...
    df_results_cegarabou_complete_cegar_as100 = df_results_cegarabou[df_results_cegarabou.filenames.str.contains("_AS_100_")]
    df_results_cegarabou_complete_cegar_as100_rs50 = df_results_cegarabou[df_results_cegarabou.filenames.str.contains("_RS_50_")]
    ...
    for title, d_cegarabou in [
        ...
        all_timeout_points = plt.scatter(s=100, x=x_all_timeouts, y=y_all_timeouts, color="r", marker="x", clip_on=False)
