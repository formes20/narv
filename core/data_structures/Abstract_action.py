...
class Abstract_action:
    ...
    #                 if is_subseq(self.name_1.split("+"),action.name_1.split("+")) and is_subseq(self.name_1.split("+"),action.name_2.split("+")):
    ...
    #     if self.types == "combine":
    #         output ="{}combine{}".format(self.name_1,self.name_2)
    #         for rela in self.rely:

    #         relation = "\t".join(rela.name1 for rela in self.rely,rela.name_2)
