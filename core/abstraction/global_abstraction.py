...
def global_abstraction_based_on_contribution(network: Network,test_property:dict,do_preprocess:bool=True,sequence_length:int=50):
    ...
    #    influnce_arg = influnce_arg * layer_influence[i]
        for node in network.layers[j].nodes:
            ...
            # print(layer_max_upperbound[j-FIRST_ABSTRACT_LAYER])
            # print(j-FIRST_ABSTRACT_LAYER)
